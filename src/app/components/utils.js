...
const AURA_TOKEN_CONTRACT_ADDRESS = "0xC0c293ce456fF0ED870ADd98a0828Dd4d2903DBF";
...
export async function getAuraTokenBalance(address_) {
    if (typeof window !== "undefined") {
        ...
        try {
            const tokenContract = new ethers.Contract(AURA_TOKEN_CONTRACT_ADDRESS, tokenAbi, provider);
